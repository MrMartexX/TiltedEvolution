 ...
 * ArtifactEvent::Retired therefore remains unproven. Only a successful PQS4
 * RequestRetiredEvent, whose provider contract is request-wide drain, is
 * translated to PartyQuestAsyncSaveContract::Retire.
 */
